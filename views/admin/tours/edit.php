    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form action="<?= BASE_URL ?>tour/update?id=<?= htmlspecialchars($tour['id'] ?? '') ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="price" name="price" step="1000" min="0" value="<?= htmlspecialchars($tour['price'] ?? '') ?>" placeholder="Nhập giá tour" required>
                    </div>
                    <div class="mb-3">
                        <label for="num_reviewsphome" class="form-label fw-semibold">Số lượt đánh giá</label>
                        <input type="number" class="form-control" id="num_reviews" name="num_reviews" min="0" value="<?= htmlspecialchars($tour['num_reviews'] ?? 0) ?>" placeholder="Nhập Số lượt đánh giá">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea  class="form-control" id="description" name="description" rows="5" placeholder="Nhập mô tả chi tiết về tour" required><?= htmlspecialchars($tour['description'] ?? '') ?></textarea>
                    </div> 
                    <div class="mb-3">
